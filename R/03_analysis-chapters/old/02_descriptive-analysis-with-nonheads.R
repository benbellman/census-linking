...
#### Figures about demographic context (part 1) ####
...
#### Figures about sample demographics (part 2) ####

# Figure 5
# Homeownership of household in time 1
linked %>% 
  filter(race_cat != "Other") %>% 
...
ggplot() +
  ...
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure5_tenure-by-race.png"), height = 3, width = 6)
...
ggplot() +
  ...
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure6_non-head-breakdown.png"), height = 5, width = 5)

# Figure 7
# SEI distributions by race and housing tenure
...
linked %>% 
  ...
  ggsave(here("figures", "new_chp2", "figure7_sei-by-race-year-tenure.png"), height = 5, width = 7)
...
linked %>% 
  ...
  theme_bw() +
  theme(panel.grid = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure8_age-by-race-year-tenure.png"), height = 5, width = 7)


# Figure 9
# Neighborhood type in time 1 by housing tenure
linked %>% 
  filter(race_cat != "Other" & head_tenure1 != "Missing Data" & is.na(ed_custom1) == F) %>% 
  ...
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure9_neigh-by-race-year-tenure.png"), height = 7, width = 7)



#### Mobility Analysis (part 3) #### 
...
linked %>% 
  ...
  mutate(n_move = n(), 
         ...
         y_pos = case_when(
           ...
           move_type == "Short Move" & race_cat == "Black" ~ 70,
           move_type == "Short Move" & race_cat == "White Imm" & year1 == 1910 ~ 70,
           move_type == "Short Move" & race_cat == "White Imm" & year1 == 1920 ~ 65,
           move_type == "Short Move" & race_cat == "White Imm" & year1 == 1930 ~ 50,
           move_type == "Short Move" & race_cat == "White NB" & year1 == 1910 ~ 70,
           move_type == "Short Move" & race_cat == "White NB" & year1 == 1920 ~ 65,
           move_type == "Short Move" & race_cat == "White NB" & year1 == 1930 ~ 55
         )) %>% 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        panel.grid.minor.y = element_blank(),
        axis.text.x = element_text(angle = 25)) +
  ggsave(here("figures", "new_chp2", "figure10_moves-by-race-year.png"), height = 3, width = 6)
...
linked %>% 
  ...
  unique() %>% 
  filter(head_tenure1 != "Missing Data" & race_cat != "Other") %>% 
  ggplot() +
  geom_col(aes(x = decade, y = Pct, fill = move_type)) +
  geom_text(aes(x = decade, y = y_pos, label = paste0(str_remove(as.character(Pct), "\\.[0-9]$"), "%")), size = 3) +
  scale_fill_manual(values = ghibli_palette("LaputaMedium", direction = -1)) +
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        panel.grid.minor.y = element_blank(),
        axis.text.x = element_text(angle = 25)) +
  ggsave(here("figures", "new_chp2", "figure11_moves-by-race-year-tenure.png"), height = 7, width = 7)
...
linked %>% 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        panel.grid.minor.y = element_blank(),
        axis.text.x = element_text(angle = 25)) +
  ggsave(here("figures", "new_chp2", "figure12_moves-by-race-and-neigh.png"), width = 6, height = 5)
...
linked %>% 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        panel.grid.minor.y = element_blank(),
        axis.text.x = element_text(angle = 25)) +
  ggsave(here("figures", "new_chp2", "figure13_white-moves-by-neigh-tenure.png"), width = 6, height = 5)


# Figure 14
# Alluvial diagram of long movers leaving black neighborhoods
...
filter(alluv, race_cat != "Other" & move_type == "Long Move") %>% 
  ...
  ggsave(here("figures", "new_chp2", "figure14_alluv-all-leftn.png"), height = 11, width = 9)
...
rbind(part1_long, part2_long, part3_long) %>% 
  ...
  facet_grid(race_cat ~ year1) +
  labs(fill = "% of Linked Records\nThat Made Long Move") +
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure15_map-long-move-rates.png"), width = 9, height = 9)
...
rbind(part1_moveto, part2_moveto, part3_moveto) %>% 
  ...
  labs(fill = "% of Long Moves") +
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure16_map-long-move-dests.png"), width = 9, height = 9)
...
ggplot() +
  ...
  geom_segment(
    data = filter(flows, ed_custom1 == "Black Neigh."),
  ...
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure17_flowmaps-black-neigh.png"), width = 9, height = 9)
...
ggplot() +
  ...
  geom_segment(
    data = filter(flows, ed_custom1 == "Imm. Neigh."),
    aes(x = X1, xend = X2, y = Y1, yend = Y2, size = n_class),
    arrow = arrow(angle = 40, length = unit(0.15, "cm"))
  ) +
  scale_size_manual(values = c(0.3, 0.5, 0.7)) +
  ...
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure18_flowmaps-imm-neigh.png"), width = 9, height = 9)
...
ggplot() +
  ...
  geom_segment(
    data = filter(flows, ed_custom1 == "White Neigh."),
    aes(x = X1, xend = X2, y = Y1, yend = Y2, size = n_class),
    arrow = arrow(angle = 40, length = unit(0.15, "cm"))
  ) +
  scale_size_manual(values = c(0.3, 0.5, 0.7)) +
  ...
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "figure19_flowmaps-white-neigh.png"), width = 9, height = 9)
...
bit_10 <- load_microdata(10, formatted = F) %>% select(year, ed, race, bpl, ownershp, relate, sei)
bit_20 <- load_microdata(20, formatted = F) %>% select(year, ed, race, bpl, ownershp, relate, sei)
bit_30 <- load_microdata(30, formatted = F) %>% select(year, ed, race, bpl, ownershp, relate, sei)
bit_40 <- load_microdata(40, formatted = F) %>% select(year, ed, race, bpl, ownershp, relate, sei)


own_ed_data <- rbind(bit_10, bit_20, bit_30, bit_40) %>% 
...
own_ed_data <- own_ed_data %>% 
  group_by(race_cat) %>% 
  group_split() %>% 
  map(right_join, rename(rbind(ed10, ed20, ed30, ed40), year1 = year))
...
ggplot(own_ed_data) +
  ...
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "maps_pct_owner.png"), height = 11, width = 9)


### Mean SEI
sei_ed_data <- rbind(bit_10, bit_20, bit_30, bit_40) %>% 
  mutate(race_cat = case_when(race %in% c(200, 210) ~ "Black",
                              race == 100 & bpl >= 15000 ~ "White Imm",
                              race == 100 & bpl < 15000 ~ "White NB",
                              TRUE ~ "Other")) %>% 
...
ggplot(sei_ed_data) +
  ...
  theme_bw() +
  theme(axis.text = element_blank(), axis.ticks = element_blank()) +
  ggsave(here("figures", "new_chp2", "maps_mean_sei.png"), height = 11, width = 9)
