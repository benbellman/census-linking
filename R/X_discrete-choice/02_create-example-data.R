...
dest_sei <- tibble(dest_ed_pct_black = 1,
                   dest_ed_pct_frnbrn = 15,
                   dest_ed_mean_sei = 1:40, 
                   dist = 1000, 
                   dest_cat = "Mean SEI",
                   serial1 = 2)

dest_dist <- tibble(dest_ed_pct_black = 15,
                   dest_ed_pct_frnbrn = 15,
                   dest_ed_mean_sei = 15, 
                   dist = seq(25, 2500, 25), 
                   dest_cat = "Distance",
...
# save example data
write_csv(all_ex, here("data", "for_models", "dc-pred-examples-final.csv"))
